<%@ page language="java" 
    ...
    import = "com.abrstech.obd2.security.*, java.text.DateFormat, java.text.SimpleDateFormat,java.util.Date"
%>
...
String loginAutoBusiness = "&nbsp;&nbsp;&nbsp;&nbsp;[&nbsp; <A href=\"/ivweb/marketPlaceMoreDetails.jsp\">Trusted Mechanic</A> &nbsp;]";
...
<form name="showRequests" action="/ivweb/marketPlacePerCountry.jsp" method="post">
...
<td><%=loginAutoBusiness%></td>
<td><%=loginAutoOwner%></td>
</tr>
...
<h3><%=country%> Sample Maintenance Request Listing </h3>

<sql:setDataSource dataSource="jdbc/abrstech_obd2db" />

<sql:query var="rs">    
	SELECT CAR.country, CAR.year, CAR.make, CAR.model, REQUEST.vin, REQUEST.currentzipcode, REQUEST.odometer, REQUEST.datetime, REQUEST.servicesrequested 
	FROM abrstech_obd2db.car_mtnc_request_tbl as REQUEST 
	JOIN (abrstech_obd2db.ref_car_tbl as CAR) 
	ON (REQUEST.vin=CAR.vin) 
	WHERE CAR.country="<%=country%>" and REQUEST.active="y" and REQUEST.datetime>"<%=SystemDT%>"
	LIMIT 50					
</sql:query>
