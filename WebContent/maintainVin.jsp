...
if( !check.isLoggedIn( IsHuman ) ) {	// if not logged in, ask user to log in
	...
	String addToMarketPlace = "[&nbsp; <A href=\"/ivweb/showVehicleToMarketplace.jsp\">Post to Marketplace</A> &nbsp;]";
	String htmlServicesOfferedLink   = "[&nbsp;&nbsp;<A href=\"/ivweb/marketPlaceVehicleOwner.jsp\">Service Offers</A>&nbsp;&nbsp;]";
...
<table border="0">
  	 <tr>
   	    <th><%=addToMarketPlace%></th>
   	    <th><%=htmlServicesOfferedLink%></th>
   	    <th><%=htmlMaintenanceRecordDetailsLink%></th>
   	 </tr>  
</table>
    
	
<form name="maintenanceForm" action="/ivweb/saveNewMaintenanceToDB.jsp" onsubmit="return validateMaintenanceForm()" method="post">
...
<table border="0">
  ...
  <tr>
      ...
      <td> <input type="text" name="costofservice"   maxlength="10" size="10" value="0.00"/> </td>
  </tr>
