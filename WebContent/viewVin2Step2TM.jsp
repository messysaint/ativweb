...
<%
	...
	String htmlFormBegin = "<form id=\"myhiddenform\" name=\"paramNames\" action=\"/ivweb/dashBoardToggleGraphMain2TM.jsp\" method=\"post\">";
	...
	while( iter.hasNext() ) {
		...
		displayValue = tmp.get( 0 ).toString().trim();
