...
String SESSIONEmail = request.getParameter( "email" ).trim();
...
<sql:query var="rs">    
	...
	WHERE MECHANIC.email="<%=SESSIONEmail%>";   
</sql:query>

<form action="/ivweb/saveSelectedTrustedMechanicsOtherEmail.jsp" method="post">
