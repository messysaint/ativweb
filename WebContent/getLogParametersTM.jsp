...
<%    	
        ...
        if ( logs == null ) {
        	...
        	csv.readLogFile( logs[0] );
     		...
     		String htmlFormBegin = "<form name=\"paramForm\" action=\"/ivweb/activeNotificationParameterEntryFormTM.jsp\" onsubmit=\"return checkParamName()\" method=\"post\">";
...
%>
    ...
    <table width="100%" >
      <tr>
        <td width="50%">
          <iframe src="/ivweb/activeNotificationAddresses.jsp" frameborder="1" align="middle" width="100%" height="150px"> </iframe>
        </td>
      </tr>
      <tr>
        <td width="50%">
