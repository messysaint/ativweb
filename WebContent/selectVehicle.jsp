...
<script type="text/javascript" src="/ivweb/jscript/validateSearchVehicleOwnerForm.js"></script>
...
%>
	...
	<h3>Search Vehicle Owner:</h3>

	<form name="searchvehicle" action="/ivweb/searchVehicleOwner.jsp" onsubmit="return validateSearchVehicleOwnerForm()" method="post">
...
<INPUT type="submit" value="Search this Vehicle Owner">
</form>
