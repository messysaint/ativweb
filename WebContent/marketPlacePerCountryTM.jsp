...
String loginAutoBusiness = "&nbsp;&nbsp;&nbsp;&nbsp;[&nbsp; <A href=\"/ivweb/marketPlaceMoreDetailsTM.jsp\">My Serviced ZIP Codes</A> &nbsp;]";
...
<form name="showRequests" action="/ivweb/marketPlacePerCountryTM.jsp" method="post">
