...
<form name="searchobd2" action="/ivweb/obd2PIDSetParamsToSearch.jsp" onsubmit="return validateOBD2Code()" method="post">
...
<iframe src="/ivweb/showOBD2SearchResults.jsp" align="middle" width="100%" height="400px"></iframe>
