...
if( !check.isLoggedIn( IsHuman ) ) {	// if not logged in, ask user to log in
	...
	String htmlFormBegin = "<form id=\"myhiddenform\" name=\"lastLogs\" action=\"/ivweb/gaugeSelectionStep2.jsp\" method=\"post\">";
	...
	String htmlCheckBoxMid02 = "\">";
        ...
        if ( (logs == null) || (logs.length == 0) ) {
        	...
        	String backToMyAutoMechanic = "/ivweb/whatisneeded.html";
