...
//boolean fromDelete = request.getHeader("referer").endsWith( "marketPlaceDeleteVehicleListing.jsp" );	
...
int compareEmail = compareEmail = collator.compare( SESSIONEmail, email );
int compareAnswer = compareAnswer = collator.compare( SESSIONAnswer, answer );
...
<sql:query var="rs">    
	...
	WHERE REQUEST.vin="<%=SESSIONVin%>" and active="y" 	
