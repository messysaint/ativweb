...
<script type="text/javascript" src="/ivweb/jscript/validateSearchBusinessForm.js"></script>
...
%>
	...
	<h3>Search Business Entity:</h3>

	<form name="searchvehicle" action="/ivweb/searchBusinessForModification.jsp" onsubmit="return validateSearchBusinessForm()" method="post">
...
<INPUT type="submit" value="Search this Business">
</form>
