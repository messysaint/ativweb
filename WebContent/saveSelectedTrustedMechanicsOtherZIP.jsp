...
if( IVWEB_VIN == null ) {
	...
	String business_seqno = new String();
	...
	// replace with new selected
	saveMyTrustedMechanic tm2 = new saveMyTrustedMechanic();
	while( paramNames.hasMoreElements() ) {
		business_seqno = paramNames.nextElement().toString(); 				
		if( !tm2.WriteToDB( IVWEB_VIN, business_seqno ) ) {
			saveOk = false;
		}				
	}
	tm2.CloseDB();
	...
	if( !saveOk ) {
		...
		response.setHeader("Refresh", "2; URL=/ivweb/myAutoMechanic.jsp");
	}   else {
		out.println( savedMsg );	
