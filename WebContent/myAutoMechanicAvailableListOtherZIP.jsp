...
<script type="text/javascript" src="/ivweb/jscript/validateZIP.js"></script>
...
%>
	...
	<form name="searchMechanicOtherZIP" action="/ivweb/searchMechanicOtherZIP.jsp" onsubmit="return validateZIP()" method="post">
  ...
  <tr>
    <td>ZIP Code: &nbsp;</td>
    <td><input type="text" name="zip" maxlength="10" size="10" value=""/> </td>
  </tr>
