...
<form name="addnewnotificationparameter" action="/ivweb/saveNewNotificationParameterToDBTM.jsp" onsubmit="return validateNotificationParameterForm()" method="post">
