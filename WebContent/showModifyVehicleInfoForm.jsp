<%@ page language="java" 
    ...
    import = "com.abrstech.obd2.security.*,com.abrstech.obd2.log.*,java.text.Collator"
%>
...
<script type="text/javascript" src="/ivweb/jscript/validateModifyVinForm.js"></script>
...
if( !check.isLoggedIn( IsHuman ) ) {	// if not logged in, ask user to log in
	...
	String SESSIONQuestion = (String) session.getAttribute( "IVWEB_SECURITY_QUESTION" );
...
<table border="0">
 <tr>
    <th><h3>Modify Vehicle Info for VIN: " <%=SESSIONVin %></h3></th>
  </tr>
</table>
Year: <%=SESSIONYear%> &nbsp; &nbsp; &nbsp; &nbsp; Make: <%=SESSIONMake.toUpperCase()%> &nbsp; &nbsp; &nbsp; &nbsp; Model: <%=SESSIONModel%> <br><br>
  
<form name="updatevehicle" action="/ivweb/saveUpdatedVinToDB.jsp" onsubmit="return validateModifyVinForm()" method="post">
...
<option value="Zimbabwe">Zimbabwe</option>
  ...
  <tr>
    ...
    <td><input type="text" name="reminderquestion" maxlength="50" size="50" value="<%=SESSIONQuestion%>"/> </td>
  </tr>
