...
if( !check.isLoggedIn( IsHuman ) ) {	// if not logged in, ask user to log in
	...
	String zip = newSrch.getZipcode();
	String country = newSrch.getCountry();
	...
	if( !foundOk ) {
		...
		session.setAttribute( "IVWEB_ZIPCODE", zip );
...
<form name="verifyidentity" action="/ivweb/setSelectedVehicle.jsp" method="post">
